...
train_raw = pd.read_csv('resources/consumer_complaints.csv')
print(train_raw.head().to_string())
train_raw = train_raw[train_raw.consumer_complaint_narrative.notnull()]
train_raw['len_txt'] = len(train_raw.consumer_complaint_narrative.str.split())
...
OUTPUT_DIR = './resources/model_saved'
...
train_InputExamples = train_df.apply(lambda x: run_classifier.InputExample(guid=None,
                                                                   text_a = x[DATA_COLUMN],
                                                                   text_b = None,
                                                                   label = x[LABEL_COLUMN]), axis = 1)

val_InputExamples = val_df.apply(lambda x: run_classifier.InputExample(guid=None,
                                                                   text_a = x[DATA_COLUMN],
                                                                   text_b = None,
                                                                   label = x[LABEL_COLUMN]), axis = 1)
